#include <image.h>
#include <functions.h>//searches for the header file in the current direcory
//If the file is not present there then the compiler searches in the include path list
